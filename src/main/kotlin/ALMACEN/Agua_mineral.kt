...
class Agua_mineral:Bebida {
    ...
    override fun calcular_precio(cantidad:Int):Double {
        ...
        //si quitaramos que calcular precio de bebida fuese una función abstracta
        //esta simplemente llamaríamos a super.calcular precio en vez de hacer de nuevo la cuenta
    }
